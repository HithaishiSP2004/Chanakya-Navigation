...
export const mockVenues: Venue[] = [
  ...
  // ==================== ADMINISTRATIVE BLOCK ====================
  {
    ...
    imageUrl: '/images/venues/admin-block-new-0.jpeg',
    heroImage: '/images/venues/admin-block-new-0.jpeg',
    photos: [
  ...
  // ==================== ADMIN BLOCK CAFETERIA ====================
  {
    ...
    imageUrl: '/images/venues/admin-cafeteria-0.jpeg',
    heroImage: '/images/venues/admin-cafeteria-0.jpeg',
    photos: ['/images/venues/admin-cafeteria-0.jpeg'],
    isAccessible: true,
    openingHours: '8:30 AM - 6:00 PM',
  ...
  // ==================== LIBRARY ====================
  {
    ...
    imageUrl: '/images/venues/library-0.jpeg',
    heroImage: '/images/venues/library-0.jpeg',
    photos: [
  ...
  // ==================== AUDITORIUM ====================
  {
    ...
    imageUrl: '/images/venues/auditorium-0.jpeg',
    heroImage: '/images/venues/auditorium-0.jpeg',
    photos: ['/images/venues/auditorium-0.jpeg'],
    isAccessible: true,
  ...
  // ==================== FOOD COURT ====================
  {
    ...
    imageUrl: '/images/venues/food-court-0.jpeg',
    heroImage: '/images/venues/food-court-0.jpeg',
    photos: ['/images/venues/food-court-0.jpeg'],
    isAccessible: true,
